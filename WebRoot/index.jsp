...
<jsp:useBean id="ccb" scope="page" class="com.bean.MemberManageBean"/>
...
<TABLE class=MainTable cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
  <TBODY>
  <TR>
    <TD><img src="<%=basePath%>images/s.jpg" width=950 height=350 border=0></TD>
...
String message = (String)request.getAttribute("message"); 
	...
	ccb.comUp1("select * from guestbook");
%>
<SCRIPT language=JavaScript>
<!--//目的是为了做风格方便
document.write('</div>');
