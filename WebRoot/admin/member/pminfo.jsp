...
<TABLE width="100%" border=1 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
   ...
   <tr>
   <td align=right>性别：</td><td align=left><%=list.get(1).toString() %></td>
   </tr>
   <tr>
   <td align=right>身份证号码：</td><td align=left><%=list.get(2).toString() %></td>
   </tr>
   <tr>
   <td align=right>所在地：</td><td align=left><%=list.get(3).toString() %> <%=list.get(4).toString() %></td>
   </tr>
   <tr>
