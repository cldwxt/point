...
%>
         ...
         <TABLE  height=237 cellSpacing=0  cellPadding=0 width="100%" border=0 hspace="12">
                          ...
                          <TR >
                            ...
                            <TD width=556 height=26 align=left>
							<INPUT type="radio" name="sex" value="男" checked="checked"> 男 <input type="radio" name="sex" value="女" > 女</TD></TR>
						  <TR >
						    <TD vAlign=center align=right  height=26>&nbsp;&nbsp;身份证号码：</TD>
						    <TD width=556 height=26 align=left>
						    <INPUT class=inputb maxLength=24 size=30 name=bir > </TD></TR>
                          <TR >
                            <TD vAlign=center align=right  height=12>所在地：</TD>
