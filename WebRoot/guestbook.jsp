						...
						<TBODY>
							<TR>
								<TD align=left class=head>
									<FONT color=#000000>您现在的位置：<SPAN
										style="TEXT-DECORATION: none">交流平台
									</FONT>
								</TD>
							</TR>
						</TBODY>
							...
							<TR>
								<TD class=Atd width="82%">
									...
									<A title="QQ:<%=pagelist2.get(4).toString()%>"
										href="tencent://message/?uin=<%=pagelist2.get(4).toString()%>&Site=网站名称&Menu=yes"><IMG
									...
									<A title=网址 href="<%=pagelist2.get(5).toString()%>"
										target="_blank"><IMG height=16
											src="<%=basePath%>images/face/ie.gif" width=16 border=0>
									</A>&nbsp;
									<A title=博客地址 href="<%=pagelist2.get(6).toString()%>"
										target="_blank"><IMG height=16
